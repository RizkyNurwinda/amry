      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- Earnings (Monthly) Card Example -->
            <?php
             $query6 = "SELECT COUNT(*) AS jumlah_bulanan FROM tb_antrian GROUP BY MONTH(tanggal)";
                                $result = mysqli_query($koneksi, $query6);
                                while($row = mysqli_fetch_array($result)){
                                ?>
            <!-- <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-sm font-weight-bold text-primary text-uppercase mb-1">Kunjungan Bulan ini</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $row['jumlah_bulanan'];?> </div>
                    </div>
                    <div class="col-auto">
                      <i class="fab fa-accessible-icon fa-2x text-gray-300"></i>
                    </div>
           ...
           <!--  <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-sm font-weight-bold text-primary text-uppercase mb-1">Dokter</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $row['total'];?> </div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-user-md fa-2x text-gray-300"></i>
            ...
            <!-- <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-sm font-weight-bold text-primary text-uppercase mb-1">Apoteker</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $row['total'];?> </div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-user-md fa-2x text-gray-300"></i>

		                    ...
		                    <form action="" method="post">
		                      <div class="form-group row">
		                        <table  id="dataTable" width="100%" cellspacing="0">
		                        	...
		                        	<tr>
		                        		<?php
										    $querypro = mysqli_query($koneksi, "SELECT tb_antrian.no_antrian FROM tb_periksa, tb_poli, tb_antrian WHERE tb_poli.id_poli=tb_antrian.id_poli AND tb_periksa.id_poli=tb_poli.id_poli AND tb_periksa.id_status_periksa=3 AND tb_periksa.id_poli=1 AND tb_periksa.tanggal_periksa=CURRENT_DATE() and tb_antrian.tanggal=CURRENT_DATE()  GROUP BY tb_periksa.id_periksa");
		                        	...
		                        	<tr>
		                        		<td>&nbsp;</td>
		                        		<td align="center"><?php include '../jam.php'; ?></td>
		                        		<td>&nbsp;</td>
		                        	</tr>
		                        	<TR><TD>&nbsp;</TD></TR>
		                        	<tr>

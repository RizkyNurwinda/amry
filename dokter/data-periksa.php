...
<body>
	...
	<?php 
		...
		if (isset($id_user) AND !empty($id_user)) {
			...
			$idpoli = $poli['id_poli'];
			$no_antri = $poli['no_antrian'];

			var_dump($id_user); var_dump($idpoli);
			
			// Update id status periksa
			$querysprks = mysqli_query($koneksi, "UPDATE tb_periksa SET id_status_periksa = 3 WHERE id_user='$id_user' AND id_poli = '$idpoli' and tanggal_periksa = current_date()");
		...
		<div class="top_menu row m0">
			<div class="container">
				<div class="float-right">
					<ul class="right_side">
						<li>
							<a href="login.php"><i class="lnr lnr-phone-handset"></i>012-6532-568-9746</a>
						</li>
						<li>
							<a href="#"><i class="lnr lnr-envelope"></i>official.iwars@gmailcom</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<form action="insert-periksa.php" method="post">
						...
						<div class="form-group row">
		                  ...
		                  <div class="col-sm-10">
		                    <input type="text" name="nama" class="form-control" required value="<?php echo $namaa ?>">
		                  </div>
		                </div>
		                <div class="form-group row">
		                  <label class="col-sm-2 col-form-label">No. Identitas</label>
		                  <div class="col-sm-10">
		                    <input type="text" name="no_identitas" class="form-control" required value="<?php echo $noidentitas ?>">
		                  </div>
		                </div>
						<div class="form-group row">
		                  <label class="col-sm-2 col-form-label">Tanggal Periksa</label>
		                  <div class="col-sm-10">
		                    <input type="date" name="tanggal_periksa" class="form-control" required value="<?php echo $tanggal ?>">
		                  </div>
		                </div>
		             	<div class="form-group row">

...
<body>
	<?php 
		...
		if (isset($id_user) AND !empty($id_user)) {
			...
			$querysprks = mysqli_query($koneksi, "UPDATE tb_periksa SET id_status_periksa = 1 WHERE id_user='$id_user' AND id_poli = '$idpoli'");
							...
							<div class="col-lg-12 pr-0">
								<ul class="nav navbar-nav center_nav pull-right">
									...
									<li class="nav-item active">
										<a class="nav-link" href="antrian-drg.php">Antrian</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="gantipass-drg.php">Ganti Password</a>
									</li>
									<li class="nav-item">
...
<table class="table table-bordered" method="post">
	...
	<tbody>
		<?php
		    ...
		    $query = mysqli_query($koneksi, "SELECT tb_antrian.no_antrian, tb_user.nama, tb_periksa.id_status_periksa, tb_periksa.id_user FROM tb_antrian , tb_user , tb_periksa where tb_antrian.id_user =  tb_user.id_user and tb_user.id_user = tb_periksa.id_user and tb_periksa.tanggal_periksa = CURRENT_DATE() and tb_periksa.id_poli = 2 and tb_antrian.tanggal = CURRENT_DATE() group by tb_antrian.id_antrian");
		...
		?>
			...
			<td>
				...
				?>
					<a href="data-periksa2.php?id_user=<?php echo $data ['id_user']?>" class="btn btn-primary" name="periksa" value="submit" >Periksa</a>
				<?php 
					}
				?>
			</td>
			...
			$id_user=$_GET['id_user'];
			$query="UPDATE tb_periksa SET id_status_periksa = 3 where id_poli = 2 and tanggal_periksa = CURRENT_DATE() where id_user='$id_user' and tanggal_periksa = CURRENT_DATE()";
